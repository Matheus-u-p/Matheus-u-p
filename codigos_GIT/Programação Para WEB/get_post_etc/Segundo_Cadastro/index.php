...
<head> <!--Aba do site -->
    ...
    <body>  <!--Corpo do site -->
    <h4><a href="login.php"> Login </a></h4></br> <!--h4 é o tamanho da fonte do texto | 'a href' é um link redirecionavel para o login.php | <br> para quebrar a linha-->

    <h4><a href="busca.php"> Buscar </a></h4>
    </body>
